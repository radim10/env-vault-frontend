...
interface DataTableProps {
  workspaceId: string
  userId: string
  columns: ColumnDef<UserAccessProject>[]
}

const UserAccessTable: React.FC<DataTableProps> = ({ columns, userId, workspaceId }) => {
